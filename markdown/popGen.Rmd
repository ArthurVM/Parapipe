...
```{r}
vcf <- read.vcfR( "/home/amorris/BioInf/Parapipe/Cparvum_AH_Chom.vcf", verbose = FALSE )
dna <- ape::read.dna("/home/amorris/BioInf/Parapipe/PRJNA633764_A/REFDATA/cryptosporidium_parvum.fasta", format = "fasta")
gff <- read.table("/home/amorris/BioInf/Parapipe/PRJNA633764_A/REFDATA/cryptosporidium_parvum.gff", sep="\t", quote="")
